...
const Slider = ({pictures}) => {
    ...
    return <div className="caroussel"> 
                ...
                <div className="slider-infos">
                    <a onClick={() => previous()} className="slider-chevron-left"><img className="banner-image" src={LeftArrow} alt="leftarrow" /></a>
                    <a onClick={() => next()} className="slider-chevron-right"><img className="banner-image" src={RightArrow} alt="rightarrow"/></a>
                </div>
